...
export default function PosterResults({ posterRef, posterData }) {
  ...
  return (
    <div style={{ position: 'fixed', left: -99999, top: 0 }}>
      ...
      >
        ...
        >
          <div>
            <div style={{ fontSize: 38, letterSpacing: '2px' }}>
            ...
            <div style={{ marginTop: 38, fontSize: 24 }}>
        ...
        {/* list */}
        <div
          style={{ marginTop: 60, marginBottom: 60, display: 'grid', gap: 30 }}
        >
